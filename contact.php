...
if (isset($_POST['submit'])) {
    ...
    $conn_query=mysqli_query($connection,$insert);
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-7">
                            <form action="<?php echo $_SERVER['PHP_SELF']?>" method="post" class="">
                                ...
                                <button name="submit" class="w-100 btn form-control border-secondary py-3 bg-white text-primary " type="submit">Submit</button>
                            </form>
                        </div>
                        <div class="col-lg-5">
